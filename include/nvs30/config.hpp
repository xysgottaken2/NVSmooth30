...
struct Config {
    ...
    bool sm75_abi_probe = false;           // contract-survey mode (path 3 milestone 0);
                                     // replaces intercepted modules with sm_75 no-op stubs and
                                     // logs every kernel contract. Never for gameplay.
